...
if __name__ == '__main__':
	...
	parser.add_argument('-c', '--ckpt_pth', type = str, default = '/content/ckpt/ckpt_19',
						 help = 'path to load checkpoints')
	parser.add_argument('-s', '--src_pth', type = str, default = '/content/drive/MyDrive/LJSpeech/validation/LJ001-0030.wav',
						 help = 'path to source')
